...
class ActsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create act" do
    assert_difference('Act.count') do
      post acts_url, params: { act: { bot_say: @act.bot_say, lesson_id: @act.lesson_id, link: @act.link } }
    end
  ...
  test "should update act" do
    patch act_url(@act), params: { act: { bot_say: @act.bot_say, lesson_id: @act.lesson_id, link: @act.link } }
